...
export default function Artisan() {
  return (
    <main className="max-w-3xl mx-auto py-16 px-4">
      ...
      <img src="https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=600&q=80" alt="Artisanat" className="mx-auto mb-6 rounded-lg shadow-lg w-full h-56 object-cover" />
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Meuble artisanal" className="rounded-lg shadow w-full h-32 object-cover" />
        <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=400&q=80" alt="Atelier artisan" className="rounded-lg shadow w-full h-32 object-cover" />
      </div>
